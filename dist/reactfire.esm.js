...
function preload(componentName, firebaseApp, settingsCallback) {
  ...
  }), "firebase-sdk:" + componentName + ":" + app.name, true);
}
...
function preloadObservable(source, id, subscribe) {
  if (subscribe === void 0) {
    subscribe = false;
  }
